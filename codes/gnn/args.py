...
def read_args():
	...
	parser.add_argument('--data_path', type = str, default = '../../dataset/',
				   help='path to data')
	parser.add_argument('--embedding_save', type=str, default='../../dataset/embedding/',
						help='path to save embedding')
	parser.add_argument('--model_path', type = str, default='../../dataset/model/',
				   help='path to save model')
	parser.add_argument('--A_n', type = int, default=430950,
				   help = 'number of author node')
	parser.add_argument('--P_n', type = int, default=616316,
				   help = 'number of paper node')
	parser.add_argument('--V_n', type = int, default=17,
	...
	parser.add_argument('--lr', type = int, default = 0.001,
				   help = 'learning rate')
	parser.add_argument('--batch_s', type = int, default = 200000,
				   help = 'batch size')
